...
void loop() {
  ...
  uint8_t data = 0;
  isReady = 0;
  uint8_t slave1formation[] = {FORWARD, FORWARD, LEFT, FORWARD, FORWARD, LEFT, FORWARD, FORWARD, LEFT, FORWARD, FORWARD, LEFT};
  uint8_t slave2formation[] = {FORWARD, FORWARD, RIGHT, FORWARD, FORWARD, RIGHT, FORWARD, FORWARD, RIGHT, FORWARD, FORWARD, RIGHT};
  ...
  if (!digitalRead(E_BTN)){
     ...
     for(int i = 0; i < sizeof(slave1formation); i++){
            
            writePipe(slaveAddresses[0]);
